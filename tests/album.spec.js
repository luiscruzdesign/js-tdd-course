...
describe('Album', () => {
  ...
  describe('getAlbum', () => {
    ...
    it('should call fetch with the correct URL', () => {
      ...
      expect(stubedFetch).have.been.calledWith('https://api.spotify.com/v1/albums/4aawyAB9vmqN3uQ7FjRGTy');

      const album2 = spotify.album.getAlbum('4aawyAB9vmqN3uQ7FjRGTk');
      expect(stubedFetch).have.been.calledWith('https://api.spotify.com/v1/albums/4aawyAB9vmqN3uQ7FjRGTk');
    });
